...
(define g8 (game-player-set-move g7 p2 1))  ; Mauricio coloca en columna 1
...
(define g12 (game-player-set-move g11 p2 1)); Mauricio coloca en columna 1
;(victoria vertical)
; 6. Verificaciones durante el juego
(displayln "¿Se puede jugar en el tablero vacío? ")
(board-can-play? empty-board)

(displayln "¿Se puede jugar después de 12 movimientos? ")
(board-can-play? (game-get-board g12))

(displayln "Jugador actual después de 12 movimientos: ")
